...
Route::get('/order/payment/uddoktapaymerchant', '\App\Lib\UddoktapayMerchant@status');
Route::get('/payment/uddoktapaymerchant', '\App\Lib\UddoktapayMerchant@status');



 Route::get('/reseller/{email}', 'ResellerController@reseller');
...
//     Auth::routes();
    ...
    Route::group(['prefix' => 'partner', 'as' => 'merchant.', 'namespace' => 'Merchant', 'middleware' => ['auth', 'merchant','user']], function () {
        ...
        Route::get('/domain/product','DomainController@getDomainProduct')->name('domain.product');
        
         Route::get('/product/import/{id}/{domain}','DomainController@productImport')->name('domain.import');
           
        Route::get('/reseller/product','DomainController@getResellerProduct')->name('reseller.product');
        Route::post('/reseller/product/add','DomainController@addResellerProduct')->name('reseller.product.add');
...
Route::group(['as' => 'seller.', 'prefix' => 'seller', 'namespace' => 'Seller', 'middleware' => ['InitializeTenancyByDomain','PreventAccessFromCentralDomains','auth','seller','user','tenantenvironment']], function () {
    ...
    Route::get('show_product', 'ProductController@test');
